...
import { offerRideUrl } from '../../HttpServices/HttpUrls';
...
export const OfferRide = () => {
  ...
  const handleSubmit = async ()=>{
       ...
       const offerRequest = {
        ...
        const res = axios.post(url , offerRequest , {headers:headers}).then(res =>{window.location.replace('/history'); })
        .catch(err => {
       ...
       <div className="bookform d-flex align-items-center justify-content-center">
        <div className="bookform-container d-flex flex-column align-items-center">
          ...
          <div className="time-container ">
            <TimeStamp  setTime ={setTime} date = {date}/>
          </div>
